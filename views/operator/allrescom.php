			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover">
					...
					<tbody>
						...
						<?php if(Resultscom::checkExistResult($item->IdEvalution)): ?>
							<tr class="text-center">
								<td><?= Yii::$app->formatter->asDate($item->TodayDate, 'dd.MM.Y'); ?></td>
								<td><a href="/operator/totalcom/<?= $item->IdEvalution; ?>" class="btn btn-default" title="Посмотреть общий итог"><i class="fa fa-eye"></i></a></td>
							</tr>
						<?php endif; ?>
						<?php endforeach; ?>
					</tbody>
