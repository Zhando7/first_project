			...
			[
				...
				'columns' => [
					...
					[
						...
						'value' => function($model){
							return Resultspr::getCountEva($model->IdEvalution);
						}
					],
					[
						...
						'buttons' => [
							'show' => function($url, $model){
								return Html::a('<i class="fa fa-eye"></i>', ['/main/indexselectpr/'.$model->IdEvalution], ['class' => 'btn btn-default', 'title' => 'Посмотреть результаты']);
							},
							'del' => function($url, $model){
								if(Yii::$app->user->identity['AuthKey'] == 1):
									return Html::a('<i class="fa fa-trash-o"></i>', ['/operator/deleteresultpr/'.$model->IdEvalution], [
