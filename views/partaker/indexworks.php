...
<div class="container">
	...
	<div class="row col-sm-12">
		<a href="/partaker/addfile" class="btn btn-primary" title="Начать добавление файлов"><i class="fa fa-file"></i> Добавить файл</a>
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<tr class="text-center">
					...
					<td><a href="/partaker/download/<?= $item->Id; ?>" class="btn btn-default" title="Скачать"><i class="fa fa-download"></i></a></td>
					<td><a href="/partaker/delfile/<?= $item->Id; ?>" class="btn btn-danger" title="Удалить"><i class="fa fa-trash-o"></i></a></td>
				</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
