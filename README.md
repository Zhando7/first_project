...
Так как у нас уже есть готовый каркас, теперь следует только объединить файлы данного репозитория с yii2. Для этого введите в командной строке `git clone https://github.com/Zhando7/first_project.git`
